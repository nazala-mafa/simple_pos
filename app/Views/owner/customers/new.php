...
<?= $this->section('content') ?>
  ...
  <form action="<?= site_url() ?>products/customers/create" method="post" enctype="multipart/form-data" id="main-form">
    <div class="row">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <input type="text" id="name" name="name" placeholder="masukkan nama barang" class="form-control <?= (session('errors.name'))? 'is-invalid': '' ?>" value="<?= old('name') ?>" required>
              <div class="invalid-feedback"> <?= session('errors.name') ?> </div>
            </div>
            <div class="form-group">
              <label for="phone" class="form-label">Nomor Telepon</label>
              <input type="number" id="phone" name="phone" placeholder="masukkan harga barang" class="form-control <?= (session('errors.phone'))? 'is-invalid': '' ?>" value="<?= old('phone') ?>" required>
              <div class="invalid-feedback"><?= session('errors.phone') ?></div>
            </div>
            <div class="form-group">
              <label for="address" class="form-label">Alamat</label>
              <input type="text" id="address" name="address" placeholder="masukkan harga barang" class="form-control <?= (session('errors.address'))? 'is-invalid': '' ?>" value="<?= old('address') ?>" required>
